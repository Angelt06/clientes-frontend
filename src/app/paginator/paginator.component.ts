...
export class PaginatorComponent implements OnInit, OnChanges {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    let paginadorActualidado = changes['paginador'];

    if (paginadorActualidado.previousValue){ // si paginadorActualizado tiene un valor previo  (es decir se ha actualizado)
